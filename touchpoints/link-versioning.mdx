...
description: Understanding how Proxify tracks link changes and manages version history for better campaign management and analytics.
---
...
When you edit a touchpoint's short link, Proxify creates a **new version** while keeping the old version fully functional. This means:
