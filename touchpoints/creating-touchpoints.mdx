...
<AccordionGroup>
  ...
  <Accordion title="Audience & Distribution Planning">
    ...
    **Channel Strategy**:
    ...
    - **WiFi**: Venues, events, customer locations *(Coming Soon)*
    - **NFC**: Business cards, product tags, interactive displays *(Coming Soon)*
  </Accordion>
...
<Steps>
  <Step title="Access touchpoint creation">
    Navigate to your Li2.ai dashboard and click **"Create Touchpoint"** or go to **Touchpoints** → **"+ Create Touchpoint"**.
  </Step>
...
<Steps>
  <Step title="Understand link generation">
    **Automatic Generation**: Li2.ai creates unique short links using the format `li2.ai/[unique-string]`
...
<AccordionGroup>
  ...
  <Accordion title="QR Code Channel Configuration ✅">
    ...
    **Design Considerations**:
    - Branded appearance with Li2.ai logo
...
<CardGroup cols={2}>
  ...
  <Card
    title="Link Versioning Management"
    icon="code-branch"
...
<CardGroup cols={3}>
  ...
  <Card
    title="UTM Parameter Management"
    icon="chart-line"
