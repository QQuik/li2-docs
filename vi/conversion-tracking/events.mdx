...
<Note>
**Dùng app iOS?** Trang này dành cho **Li2 Analytics SDK (web/JavaScript)**. Nếu bạn track conversion từ app iOS, **Li2 Swift SDK** có API định kiểu riêng (`trackDirectLead` / `trackAttributedLead` / `trackAttributedSale` / `identify`) tự gắn về deep-link match — xem [Đo lường chuyển đổi trong Tích Hợp App](/vi/deep-links/mobile-integration#đo-lường-chuyển-đổi-conversion-tracking).
</Note>
...
<CardGroup cols={2}>
  <Card title="GTM Integration" icon="google" href="./integrations/google-tag-manager">
    Triển khai tracking qua Google Tag Manager
  </Card>
