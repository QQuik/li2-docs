...
## Dữ liệu bạn có thể theo dõi

- **Lượt nhấp (Clicks)**: tổng số lần link được truy cập.
- **Lượt quét (Scans)**: số lần QR code được quét.
- **Nguồn giới thiệu (Referrers)**: link đến từ kênh nào (Facebook, Email, Ads, Zalo…).
- **Thiết bị & hệ điều hành**: người dùng dùng mobile, desktop, iOS, Android.
- **Vị trí địa lý**: thành phố, quốc gia người dùng click/scan.
- **Timeline**: xu hướng theo ngày/giờ.
...
- Đăng nhập 👉 [app.li2.ai](http://app.li2.ai).
- Chọn mục **Phân tích (Analytics)** ở menu bên trái.
- Xem dữ liệu:
  - Biểu đồ lượt nhấp/quét theo thời gian.
  - Phân tích theo thiết bị, nguồn giới thiệu, vị trí.
- (Tuỳ chọn) Lọc dữ liệu theo ngày, tag, hoặc kênh.
