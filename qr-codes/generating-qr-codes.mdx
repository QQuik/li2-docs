...
QR codes in Proxify are automatically generated when you enable the QR channel in your touchpoints. This seamless integration ensures every QR code is connected to your analytics, campaign tracking, and multi-channel strategy from the moment of creation.
...
<Steps>
  ...
  <Step title="Enable QR channel">
    ...
    4. You'll see the QR code appear immediately
  </Step>
...
<AccordionGroup>
  <Accordion title="Instant generation process">
    **Automatic Creation**:
    ...
    - Includes Proxify branding for professional appearance
  ...
  <Accordion title="Default settings applied">
    **Standard Appearance**:
    ...
    - Professional Proxify branding included
...
<AccordionGroup>
  <Accordion title="QR generation availability">
    **Current Access**:
    - Available for all Proxify accounts
