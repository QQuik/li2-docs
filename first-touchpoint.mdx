...
description: Step-by-step guide to creating your first professional marketing touchpoint with multi-channel distribution, custom branding, and analytics tracking.
---

# Create Your First Touchpoint

Creating your first touchpoint is an exciting milestone! In this comprehensive guide, you'll build a professional marketing asset that showcases Proxify's multi-channel distribution capabilities. By the end, you'll have a working short link, branded QR code, and analytics tracking.
...
- ✅ Access to your [Proxify dashboard](https://app.li2.ai)
...
<Steps>
  <Step title="Navigate to touchpoint creation">
    From your Proxify dashboard, click the **"Create Touchpoint"** button. You can find this:
...
<Steps>
  <Step title="Review the auto-generated short link">
    Proxify automatically creates a short link using the format `li2.ai/[random-string]`.
  ...
  <Step title="Understand link versioning">
    When you edit a short link, Proxify creates a new version while keeping the old one accessible.
...
<Steps>
  <Step title="Create your touchpoint">
    ...
    **What happens next**:
    ...
    - QR code is automatically generated with Proxify branding
...
<CardGroup cols={2}>
  <Card
    title="Add Social Media Optimization"
    icon="share-nodes"
  ...
  <Card
    title="Explore QR Customization"
    icon="qrcode"
